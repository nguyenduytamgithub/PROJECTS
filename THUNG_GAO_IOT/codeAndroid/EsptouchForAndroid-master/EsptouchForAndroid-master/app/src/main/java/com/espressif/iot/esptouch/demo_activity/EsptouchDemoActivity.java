...
//        mDeviceCountET.setText("1");
        mConfirmBtn = findViewById(R.id.button_submit);
    ...
    public void onClick(View v) {
        if (v == mConfirmBtn) {
            ...
            byte [] bssid = EspNetUtil.parseBssid2bytes(mApBssidTV.toString());
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                String text = result.getBssid() + " đã kết nối thành công vào Wifi.";
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage("Đang kết nối thùng gạo vào Wifi \nVui lòng đợi giây lát...");
            ...
            if (!firstResult.isCancelled()) {
                ...
                if (firstResult.isSuc()) {
                    ...
                    for (IEsptouchResult resultInList : result) {
                        sb.append("Đã kết nối thùng gạo vào Wifi")
                                .append("\n")
                                .append("Địa chỉ IP thùng gạo: ")
                    ...
                    mResultDialog.setMessage("Kết nối thất bại, vui lòng kiểm tra mật khẩu wifi hiện tại hoặc nhấn giữ nút cài đặt trên thùng gạo.");
                }
